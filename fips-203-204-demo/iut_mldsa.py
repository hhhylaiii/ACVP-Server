#!/usr/bin/env python3
"""ML-DSA FIPS 204 IUT (Implementation Under Test) harness.
...
def main():
    ...
    if not os.path.exists(prompt_path):
        ...
        print("Usage: python3 iut_mldsa.py [path/to/prompt.json]")
        sys.exit(1)
    ...
    if not os.path.exists(expected_path):
        ...
        print("This demo harness requires expectedResults.json to solve the ML-DSA vectors.")
        sys.exit(1)
